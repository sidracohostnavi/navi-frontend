        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
                ...
                <div className="max-w-6xl mx-auto px-4 flex gap-6 overflow-x-auto">
                    ...
                    <Link
                        href={`/cohost/properties/${id}/direct-booking`}
                        className="py-3 text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent hover:border-gray-300 whitespace-nowrap"
                    >
                        Direct Booking
                    </Link>
                </div>
