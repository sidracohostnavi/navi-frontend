export default function CoHostHome() {
  const links = [
    { href: "/cohost/messaging/inbox", title: "Messaging Inbox", desc: "Review + approve guest messages" },
  ...
  return (
    <main style={{ maxWidth: 920, margin: "0 auto", padding: "48px 20px" }}>
      <h1 style={{ fontSize: 36, marginBottom: 8 }}>CoHost</h1>
      <p style={{ opacity: 0.8, marginBottom: 28 }}>
        Choose a CoHost module:
      </p>
