...
export default function CoHostLandingPage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-rose-50 to-white">
            {/* Navigation */}
            <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-sm border-b border-rose-100 z-50">
                <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <span className="text-2xl">🏠</span>
                        <span className="text-xl font-semibold text-rose-600">Navi CoHost</span>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <Link
                            href="/auth/signup"
                            className="bg-rose-500 hover:bg-rose-600 text-white px-5 py-2 rounded-full font-medium transition"
                        >
                            Start Free
                        </Link>
                    </div>
            ...
            <section className="pt-32 pb-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <p className="text-rose-600 font-medium mb-4">Built by a real host who understands the chaos of managing bookings.</p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                        <Link
                            href="/auth/signup"
                            className="bg-rose-500 hover:bg-rose-600 text-white px-8 py-4 rounded-full font-semibold text-lg transition shadow-lg shadow-rose-200"
                        >
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-sm">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Airbnb', 'VRBO', 'Direct bookings', 'Cleaning blocks'].map((tag) => (
                                    <span key={tag} className="bg-rose-100 text-rose-700 px-3 py-1 rounded-full text-sm">
                                        {tag}
                                    </span>
                                ))}
                            </div>
            ...
            <section className="py-20 px-6 bg-gradient-to-b from-rose-100 to-rose-50">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <Link
                        href="/auth/signup"
                        className="inline-block bg-rose-500 hover:bg-rose-600 text-white px-10 py-4 rounded-full font-semibold text-lg transition shadow-lg shadow-rose-200"
                    >
            ...
            <footer className="py-10 px-6 bg-white border-t border-gray-100">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-600">Navi CoHost</span>
                    </div>
